...
import { getQuizJobs } from "@/services/course";
...
<div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-3xl shadow-2xl w-full max-w-5xl overflow-hidden flex flex-col h-full max-h-[70vh] animate-in fade-in zoom-in duration-300">
        ...
        <div className="p-8 border-b flex justify-between items-center bg-gray-50 shrink-0">
          <div>
            <h2 className="text-2xl font-bold text-gray-800">Quiz Generation History</h2>
            <p className="text-sm text-gray-500">View and manage your recent AI quiz generation jobs</p>
          </div>
          <button 
            onClick={setStage}
            ...
            <div className="min-w-full inline-block align-middle">
              <table className="w-full text-left border-collapse">
                ...
                <tbody className="divide-y">
                  {jobs.map((job) => (
                    <tr key={job.job_id} className="hover:bg-gray-50/80 transition-colors group text-xs">
                      <td className="py-5 font-mono">{job.job_id.slice(0, 8)}...</td>
